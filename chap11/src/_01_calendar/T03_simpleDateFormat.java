...
public class T03_simpleDateFormat {
	...
	public static void main(String[] args) {
		 ...
		 * - MM : 월 2자리, M : 월 1자리
		 * - dd : 일 2자리, d : 일 1자리
		 * - hh : 시(12시간제 0~11) 2자리, HH : 24시간제(0~23)
		 * - mm : 분
		 * - ss : 초
		 * - E : 요일
		 */
		...
		SimpleDateFormat sdf5 = new SimpleDateFormat("yyyy-MM-dd E");
		...
		try {
			...
			System.out.println(sdf8.format(strNow)); // 날짜 포맷 적용
